...
package carrito.controlador;

import carrito.config.Fecha;
import carrito.modelo.Carrito;
import carrito.modelo.Cliente;
import carrito.modelo.ClienteDAO;
import carrito.modelo.Compra;
import carrito.modelo.ComprasDAO;
import carrito.modelo.DetalleCompra;
import carrito.modelo.Pago;
import carrito.modelo.Producto;
import carrito.modelo.ProductoDAO;
import java.io.File;
...
import javax.servlet.ServletFileUpload;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion) {
            ...
            case "verDetalle":
                ...
                request.getRequestDispatcher("vista/DetalleCompra.jsp").forward(request, response);
                break;
            case "NuevoProducto":
                request.setAttribute("productos", productos);
                request.getRequestDispatcher("vista/addProducto.jsp").forward(request, response);
                break;
